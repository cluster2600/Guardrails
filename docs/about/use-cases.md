...
- **Third-party APIs**: Integrate with [ActiveFence](../configure-rails/yaml-schema/guardrails-configuration/built-in-guardrails.html#activefence), [Cisco AI Defense](../user-guides/community/ai-defense.md), and other moderation services.
